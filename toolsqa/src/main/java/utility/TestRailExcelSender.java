...
public class TestRailExcelSender {
    WebDriver driver;
    private static final Logger logger = LoggerFactory.getLogger(TestRailExcelSender.class);
    public TestRailExcelSender(WebDriver driver)
    {
        this.driver = driver;
    }
    public void testRailExcelToMail() throws InterruptedException
    {

        driver.get("https://swamyveera94414.testrail.io/index.php?/runs/view/1");
        //https://swamyveera94414.testrail.io/index.php?/runs/view/1

        driver.findElement(By.id("name")).sendKeys("veeraswamy.kalluri@optimworks.com");
        driver.findElement(By.id("password")).sendKeys("2602@Dob");
